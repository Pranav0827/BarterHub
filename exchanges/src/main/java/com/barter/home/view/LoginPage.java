...
//-----------------------------------x----------x--------------------------------------------
        ...
        Image image = new Image("assets\\images\\png-clipart-google-search-google-account-google-s-google-play-google-company-text-thumbnail.png");
        ...
        Text text = new Text("Sign in with Google");
        text.setStyle("-fx-font-size : 14px;");
        text.setTranslateX(60);
        text.setTranslateY(10);

        goo.getChildren().addAll(view1, text);
        goo.setTranslateY(-110);
        goo.setTranslateX(60);
        goo.setStyle("-fx-border-width : 1px; -fx-border-color : gray; -fx-border-radius : 10px");
        goo.setMaxWidth(270);
...
//----------------------------------------x---------------------x-------------------------------
        ...
        vbRight.getChildren().addAll(t1, l1,logUp, note, l2, email, l3, pass, l4, remBox, login, line, goo, acc);
        ...
        Scene sc = new Scene(gr, 1330, 680);
        sc.setFill(Color.web("#FCF8F3"));
        mainStage.setTitle("BarterHub : Exchange any thing");
        mainStage.show();
